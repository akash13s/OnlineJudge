...
public interface ProblemService {
    ...
    public TestCaseDTO addTestCase(String problemCode, MultipartFile inputFile, MultipartFile outputFile, boolean isSampleTest) throws IOException, InterruptedException;
